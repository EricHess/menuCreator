        ...
        <?php foreach($restaurantInfo as $restaurant) {
            ...
            foreach($catGroups as $catGroup){
                ...
                <article data-associatedgroup="<?php echo $catGroup['groupassociation']; ?>" class="restaurants mainParent <?php echo $activeStatus; ?>"  data-dbName="menucategory"  data-idType="cid" data-neededId="<?php echo $catGroup["cid"]; ?>">
                    ...
                    <div class="deactivate">Active? <input  id="deactivate" rel="activeStatus" <?php if($catGroup["activeStatus"] == 1) echo "checked = checked"; ?> type="checkbox" /></div>
                    <div class="deleteMe"><button id="delete" rel="del" type="checkbox" data-genus="menucategory">Delete This Menu Category</button></div>
                </article>
            <?php }

...
class createController {
    ...
    public static function restaurantCreate($createPackage){
        ...
        $sqlStatement = "INSERT INTO `ivars235_joomla`.`restaurants` (`rid`, `rname`, `rdescription`) VALUES ('','".$name."','".$description."')";
    ...
    public static function groupCreate($createPackage){
        ...
        $sqlStatement = "INSERT INTO `ivars235_joomla`.`menugroup` (`gid`, `restaurantassociation`, `gname`, `gdescription`) VALUES ('','".$restaurantAssociation."','".$name."','".$description."')";
        mysqli_query($connect,$sqlStatement);
    }
    ...
    public static function categoryCreate($createPackage){
        ...
        $sqlStatement = "INSERT INTO `ivars235_joomla`.`menucategory` (`cid`, `restaurantassociation`, `groupassociation`, `cname`, `cdescription`) VALUES ('','".$restaurantAssociation."','".$groupAssociation."','".$name."','".$description."')";
        mysqli_query($connect,$sqlStatement);
